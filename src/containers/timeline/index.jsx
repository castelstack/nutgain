...
<div  className={`${paddingX} bg-dark-900 py-12 grid  grid-cols-1`}>
      ...
      <div className= {` py-12 grid md:grid-cols-2 grid-cols-1 items-end w-full`}>
          ...
          <div className='-space-y-4 flex flex-col '>
            ...
            >
              <div>
                ...
                <SmText className='text-white py-4'>
                  NutGain Token constitutes the ecosystem’s unique
                  crytopcurrency. After receiving pay-outs for their use of the
                  NutGain Browser and for holding the e-commerce offers
                  available only to the NutGain community.
                </SmText>
