...
const Footer = () => {
  return (
    <div
      className={`${paddingX} flex flex-col gap-12 items-start bg-dark-900 py-12`}
    >
      ...
      <hr className='text-gray-100'/>
          ...
          <p className='text-white text-sm tracking-wider'>Copyright 2021 ZOR All right reserved.</p>
    </div>
  );
};
